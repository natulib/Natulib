...
<p ><img src="../assets/NL-001A-ESP32-C6-N16-1.png" width="220" alt="ESP32-C6 N16"></p> 

---

## 🛒 Ce qu'il vous faut

| Composant | Qté |  Obligatoire | Lien d'achat | Note / Rôle |
| :--- | :--- | :--- | :--- | :--- |
| **ESP32-C6 N16 avec broches soudée** | 1 | ✅ | [Acheter sur AliExpress (Lien affilié)](ton_lien_ici) | Version 16 Mo de Flash requise |
| **Câble USB-C (données)** | 1 | ✅ | [Acheter sur AliExpress (Lien affilié)](ton_lien_ici) | Câble USB-C pour flash et alimentation 5v usb |
